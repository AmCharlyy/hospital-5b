        ...
        <>
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-black/[0.05]">
              <h2 className="text-lg font-semibold tracking-tight text-[#071952]">{titulo}</h2>
              <button onClick={onClose} className="p-2 text-[#86868b] hover:text-[#071952] hover:bg-[#EBF4F6] rounded-full transition-colors">
                <X className="w-5 h-5" />
              </button>
            </div>
            <div className="p-6">
