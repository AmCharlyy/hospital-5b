  ...
  return (
    <div className="lg:col-span-2 bg-white p-6 rounded-3xl shadow-[0_2px_20px_rgba(0,0,0,0.02)] border border-black/[0.02]">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-lg font-semibold tracking-tight text-[#1d1d1f]">Flujo de Pacientes (Semana)</h2>
      ...
      <div className="h-[300px] w-full min-w-0">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={datos} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            <Area type="monotone" dataKey="altas" stroke="#d1d5db" strokeWidth={3} fillOpacity={0.1} fill="#d1d5db" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
